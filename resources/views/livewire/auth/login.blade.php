                ...
                <form class="mt-6" wire:submit.prevent='login'>
                    <div>
                        ...
                        <input type="email" wire:model='email' placeholder="Enter Email Address"
                            class="@error('email') border-red-500 @enderror w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none"
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" wire:model.lazy='password' placeholder="Enter Password" minlength="6"
                            class="@error('email') border-red-500 @enderror w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
